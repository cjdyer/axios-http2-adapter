...
import delayAsyncDestroy from "./utils/delay-async-destroy.js";
...
const closeCoveredSessions = (where, session) => {
    ...
    for (let index = 0; index < where.length; index++) {
        ...
        if (
            ...
            coveredSession[kCurrentStreamCount] +
            ...
            const entry = async () => {
                ...
                try {
                    ...
                    if (computedOptions.session === undefined) {
                        computedOptions.session =
                            this.tlsSessionCache.get(name);
                    }

                    const createConnection =
                        computedOptions.createConnection ||
                    ...
                    const processListeners = () => {
                        ...
                        for (let index = 0; index < originSet.length; index++) {
                            ...
                            if (origin in queue) {
                                ...
                                if (
                                    queue[origin].listeners.length === 0 &&
                                    !completed
                                ) {
                                    delete queue[origin];
