...
import validateHeaderName from "./utils/validate-header-name.js";
import validateHeaderValue from "./utils/validate-header-value.js";
import proxySocketHandler from "./utils/proxy-socket-handler.js";
...
class ClientRequest extends Writable {
    constructor(input, options, callback) {
        ...
        if (options.h2session) {
            ...
            this.protocol = this[kSession].socket.encrypted
                ? "https:"
                : "http:";
        ...
        if (reuseSocket) {
            ...
            this.agent
                .getSession(this[kOrigin], this[kOptions])
                .catch(() => {});
        }
        ...
        const onStream = (stream) => {
            ...
            stream.once("aborted", () => {
                ...
                if (res) {
                    ...
                    this.destroy(
                        new Error("The server aborted the HTTP/2 stream")
                    );
                }
            });
            ...
            const onResponse = (headers, flags, rawHeaders) => {
                ...
                if (isConnectMethod) {
                    ...
                    if (
                        this.emit("connect", response, stream, Buffer.alloc(0))
                    ) {
                        this.emit("close");
                    } else {
